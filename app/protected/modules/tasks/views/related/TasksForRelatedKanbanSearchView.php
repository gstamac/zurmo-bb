<?php
    ...
    class TasksForRelatedKanbanSearchView extends TasksSearchView
    {
        ...
        {   
            ...
            {
                $gridId = get_class($this->model->getKanbanBoard()->getRelatedModel()) . '-tasks-kanban-view';
            }
        ...
        {   
            ...
            $modelClassName = get_class($this->model->relationModel);
            $moduleClassName = $modelClassName::getModuleClassName();
            $moduleId = $moduleClassName::getDirectoryName();
            $params['id'] = $this->model->getKanbanBoard()->getRelatedModel()->id;
            if ($modelClassName != 'Project')
            {
                $params['kanbanBoard'] = 1;
            }
            $this->model->loadSavedSearchUrl = Yii::app()->createUrl($moduleId . '/default/details/', $params);
