<?php
    ...
    /**
     * Checks that memcached is installed and has the correct minimum version.
     */
    class MemcachedServiceHelper extends ServiceHelper
    {
        protected $required = false;

        protected $minimumVersion = '2.0.0';

        protected function checkService()
        {
            return $this->checkServiceAndSetMessagesByMethodNameAndDisplayLabel('checkMemcached',
                                                                                Zurmo::t('InstallModule', 'Memcached extension'));
        }
        ...
        protected function checkServiceAndSetMessagesByMethodNameAndDisplayLabel($methodName, $displayLabel)
        {
            ...
            else
            {
                if (extension_loaded('memcached'))
                {
                    ...
                    {
                        $this->message  = $displayLabel . ' ' .
                                          Zurmo::t('InstallModule', 'version installed:') . ' ' . $actualVersion;
                    }
                }
                else
                {
