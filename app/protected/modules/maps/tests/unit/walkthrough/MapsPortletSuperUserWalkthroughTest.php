<?php
    ...
    class MapsPortletSuperUserWalkthroughTest extends ZurmoWalkthroughBaseTest
    {
        ...
        public function testAddingMapPortletToAccountsDetailView()
        {
            ...
            $this->assertEquals(round('42.11469', 4),  round($accounts[0]->billingAddress->latitude, 4));
            $this->assertEquals(round('-87.979699', 4), round($accounts[0]->billingAddress->longitude, 4));
